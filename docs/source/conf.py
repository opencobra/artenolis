...
# of the sidebar.
#
html_logo = '_static/img/logo_artenolis.png'
...
htmlhelp_basename = 'ARTENOLISDoc'
...
latex_documents = [
    (master_doc, 'ARTENOLIS.tex', u'ARTENOLIS Documentation',
     u'The ARTENOLIS'' developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'artenolis', u'ARTENOIS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ARTENOLIS', u'ARTENOLIS Documentation',
     author, 'ARTENOLIS', 'One line description of project.',
     'Miscellaneous'),
]
